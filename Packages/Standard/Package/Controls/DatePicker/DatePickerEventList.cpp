...
namespace nitisa
{
	namespace standard
	{
		CDatePickerEventList::CDatePickerEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}IDatePicker *sender", L"sender"))
				->AddForwardDeclaration(L"class IDatePicker;", L"Standard/Controls/IDatePicker.h", L"standard");
		}
	}
}