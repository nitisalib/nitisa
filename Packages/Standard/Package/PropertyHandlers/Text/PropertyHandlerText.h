...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxMemo;

		class CPropertyHandlerText :public CPropertyHandlerModal
		{
		private:
			...
			IFormMemo *getForm();
			CDialogBoxMemo *getDialogBox();
			void setDialogText(const String &value);
		protected:
		...
		public:
			...
			CPropertyHandlerText(IPackage *package);
		};
	}
}