...
namespace nitisa
{
	namespace charts
	{
		const String CDialogBoxForexChartData::ClassName{ L"DialogBoxForexChartData" };
		
	#pragma region Service
		CDialogBoxForexChartData::CDialogBoxForexChartDataService::CDialogBoxForexChartDataService(CDialogBoxForexChartData *control) :
			IDialogBoxForexChartDataProtoService(control),
			m_pControl{ control }
		{

		}

		void CDialogBoxForexChartData::CDialogBoxForexChartDataService::NotifyOnTranslateChange()
		{
	...
	#pragma region Constructor & destrictor
		CDialogBoxForexChartData::CDialogBoxForexChartData() :
			IDialogBoxForexChartDataProto(ClassName, true, true, false, false, DesignDPI, new CDialogBoxForexChartDataService(this)),
			m_pData{ nullptr },
			m_pListener{ nullptr }
		{
		...
		CDialogBoxForexChartData::CDialogBoxForexChartData(IForm *parent) :CDialogBoxForexChartData()
		{
			setForm(parent);
		}

		CDialogBoxForexChartData::CDialogBoxForexChartData(IControl *parent) : CDialogBoxForexChartData()
		{
			setParent(parent);
		}

		void CDialogBoxForexChartData::LoadTranslatableTexts()
		{
	...
	#pragma region Interface getters
		IForexChart::IForexChartData *CDialogBoxForexChartData::getValue()
		{
			return m_pData;
		}
	#pragma endregion
	...
	#pragma region Interface setters
		bool CDialogBoxForexChartData::setValue(IForexChart::IForexChartData *value)
		{
			if (value != m_pData)
			{
				CLockRepaint lock{ this };
	...
	#pragma region Setters
		void CDialogBoxForexChartData::setUpdateListener(IUpdateListener *listener)
		{
	...
	#pragma region Helpers
		int CDialogBoxForexChartData::SelectedPointIndex()
		{
		...
		String CDialogBoxForexChartData::ItemToString(const int index)
		{
			return
		...
		bool CDialogBoxForexChartData::GetValues(float &open, float &close, float &min, float &max)
		{
	...
	#pragma region Events
		void CDialogBoxForexChartData::FormForexChartDataProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed)
		{
			bool ctrl, alt, shift;
		...
		void CDialogBoxForexChartData::ButtonAdd_OnClick(IControl *sender)
		{
		...
		void CDialogBoxForexChartData::ButtonUpdate_OnClick(IControl *sender)
		{
			float open, close, min, max;
			if (!GetValues(open, close, min, max))
				return;
		...
		void CDialogBoxForexChartData::ButtonDelete_OnClick(IControl *sender)
		{
			int index{ SelectedPointIndex() };
			if (index >= 0)
			{
		...
		void CDialogBoxForexChartData::ButtonClear_OnClick(IControl *sender)
		{
			m_pData->Clear();
		...
		void CDialogBoxForexChartData::ListBoxArray_OnSelect(IControl *sender, IListItem *item)
		{
			int index{ SelectedPointIndex() };
		...
		void CDialogBoxForexChartData::ButtonOk_OnClick(IControl *sender)
		{
			setModalResult(ModalResult::Ok);
		}

		void CDialogBoxForexChartData::ButtonCancel_OnClick(IControl *sender)
		{
			setModalResult(ModalResult::Cancel);
		}
	#pragma endregion
