...
namespace nitisa
{
	...
	namespace platform
	{
		namespace android
		{
			...
			namespace gles31d
			{
				class CRenderer :public gles::CBaseRenderer
				{
				...
				private:
					...
					gles::CVertexArrayImmutable *m_pDefaultVertexArray;
					gles::CProgramBase *m_pActiveProgramBase;
					gles::CProgramMini *m_pActiveProgramMini;
					gles::CProgramMain *m_pProgramMain;
