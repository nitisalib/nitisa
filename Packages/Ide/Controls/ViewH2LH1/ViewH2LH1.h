...
namespace nitisa
{
	...
	namespace ide
	{
		class CViewH2LH1 :public virtual IViewH2LH1, public CControl
		{
			friend class CViewH2LH1Service;
		public:
			enum class State
			{
				Normal,
		...
		public:
			...
			CViewH2LH1();
			CViewH2LH1(IForm *parent);
			CViewH2LH1(IControl *parent);
