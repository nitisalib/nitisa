...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH1H3::CViewH1H3() :
			CControl(L"ViewH1H3", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorV{ 0.5f },
		...
		{
			setService(new CViewH1H3Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH1H3::CViewH1H3(IForm *parent) :
			CViewH1H3()
		{
			setForm(parent);
		}

		CViewH1H3::CViewH1H3(IControl *parent) :
			CViewH1H3()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewH1H3::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewH1H3::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewH1H3 getters
		bool CViewH1H3::isResizable()
		{
			return m_bResizable;
		}

		float CViewH1H3::getSeparatorV()
		{
			return m_fSeparatorV;
		}

		float CViewH1H3::getSeparatorH1()
		{
			return m_fSeparatorH1;
		}

		float CViewH1H3::getSeparatorH2()
		{
			return m_fSeparatorH2;
		}
	#pragma endregion

	#pragma region IViewH1H3 setters
		bool CViewH1H3::setResizable(const bool value)
		{
		...
		bool CViewH1H3::setSeparatorV(const float value)
		{
		...
		bool CViewH1H3::setSeparatorH1(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, m_fSeparatorH2 - m_fSeparatorWidth / ntl::Max<float>(1, getWidth())) };
		...
		bool CViewH1H3::setSeparatorH2(const float value)
		{
			float v{ ntl::Clamp<float>(value, m_fSeparatorH1 + m_fSeparatorWidth / ntl::Max<float>(1, getWidth()), 1) };
	...
	#pragma region Getters
		CViewH1H3::View CViewH1H3::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH1H3::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH1H3::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH1H3::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH1H3::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH1H3::setActiveView(const View value)
		{
		...
		bool CViewH1H3::setBorderWidth(const float value)
		{
		...
		bool CViewH1H3::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH1H3::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH1H3::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH1H3::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH1H3::CalculateSeparatorVRect()
		{
		...
		RectF CViewH1H3::CalculateSeparatorH1Rect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getHeight() };
			result.Right = result.Left + m_fSeparatorWidth;
			return result;
		}

		RectF CViewH1H3::CalculateSeparatorH2Rect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H3::CalculateLeftViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH1H3::CalculateMiddleViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH1H3::CalculateRightViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H3::CalculateTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H3::CalculateLeftClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H3::CalculateMiddleClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H3::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H3::CalculateTopClientRect()
		{
			RectF result{ 0, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
