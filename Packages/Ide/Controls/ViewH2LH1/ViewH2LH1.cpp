...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH2LH1::CViewH2LH1() :
			CControl(L"ViewH2LH1", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
			m_fSeparatorX{ 0.25f },
		...
		{
			setService(new CViewH2LH1Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH2LH1::CViewH2LH1(IForm *parent) :
			CViewH2LH1()
		{
			setForm(parent);
		}

		CViewH2LH1::CViewH2LH1(IControl *parent) :
			CViewH2LH1()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewH2LH1::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewH2LH1::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewV2XV1 getters
		bool CViewH2LH1::isResizable()
		{
			return m_bResizable;
		}

		float CViewH2LH1::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewH2LH1::getSeparatorV()
		{
			return m_fSeparatorV;
		}

		float CViewH2LH1::getSeparatorX()
		{
	...
	#pragma region IViewV2XV1 setters
		bool CViewH2LH1::setResizable(const bool value)
		{
		...
		bool CViewH2LH1::setSeparatorH(const float value)
		{
		...
		bool CViewH2LH1::setSeparatorV(const float value)
		{
		...
		bool CViewH2LH1::setSeparatorX(const float value)
		{
	...
	#pragma region Getters
		CViewH2LH1::View CViewH2LH1::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH2LH1::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH2LH1::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH2LH1::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH2LH1::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH2LH1::setActiveView(const View value)
		{
		...
		bool CViewH2LH1::setBorderWidth(const float value)
		{
		...
		bool CViewH2LH1::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH2LH1::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH2LH1::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH2LH1::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH2LH1::CalculateSeparatorHRect()
		{
		...
		RectF CViewH2LH1::CalculateSeparatorVRect()
		{
		...
		RectF CViewH2LH1::CalculateSeparatorXRect()
		{
		...
		RectF CViewH2LH1::CalculateBottomViewRect()
		{
		...
		RectF CViewH2LH1::CalculateRightTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH2LH1::CalculateLeftTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH2LH1::CalculateLeftBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH2LH1::CalculateBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH2LH1::CalculateRightTopClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH2LH1::CalculateLeftTopClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH2LH1::CalculateLeftBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
