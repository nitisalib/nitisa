...
#pragma warning(disable: 4996) // Disable deprecation warning on methods implementations
		...
		namespace windows
		{
			namespace opengl
			{
				...
				protected:
					...
					bool FindPixelFormat(PlatformHandle dc, int &pf_index, const bool double_buffered, int &multisample);
