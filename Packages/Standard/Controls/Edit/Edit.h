...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CEdit :public virtual IEdit, public CControl
		{
			friend CEditService;
		private:
			class CEditTextInput :public CBuiltInTextInput
			{
			private:
				CEdit *m_pEdit;
			public:
				CEditTextInput(CEdit *edit);

				IControl *getControl() override;
				State getState() override;
			};

			class CEditListener :public virtual IBuiltInTextInputListener
			{
			private:
				CEdit *m_pEdit;
			public:
				CEditListener(CEdit *edit);
			...
			public:
				...
				CGradientListener(CEdit *control);
			};
		private:
