...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionMinusAssign::CFunctionMinusAssign(IErrorListener *error_listener, IFunction *operand1, IFunction *operand2, IFunction *modify) :
		...
		void CFunctionMinusAssign::BeforeRelease()
		{
			if (m_pOperand1)
				m_pOperand1->Release();
			if (m_pOperand2)
