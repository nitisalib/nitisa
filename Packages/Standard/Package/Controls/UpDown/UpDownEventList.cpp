...
namespace nitisa
{
	namespace standard
	{
		CUpDownEventList::CUpDownEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}IUpDown *sender", L"sender"))
				->AddForwardDeclaration(L"class IUpDown;", L"Standard/Controls/IUpDown.h", L"standard");
		}
	}
}