...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionBitwiseXorAssign::CFunctionBitwiseXorAssign(IErrorListener *error_listener, IFunction *operand1, IFunction *operand2, IFunction *modify) :
		...
		void CFunctionBitwiseXorAssign::BeforeRelease()
		{
			if (m_pOperand1)
				m_pOperand1->Release();
			if (m_pOperand2)
	...
	#pragma region IFunction methods
		bool CFunctionBitwiseXorAssign::Run()
		{
			if (!m_pOperand1)
			{
				if (m_pErrorListener)
