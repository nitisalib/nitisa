	...
	namespace platform
	{
		namespace windows
		{
			...
			namespace opengl45d
			{
				...
				private:
					enum SUBROUTINE_PATTERN
					{
						spColor,
						spGradient,
						spTexture,
						spTextureMultisample,
						spBlock,
						spText,
						spBlurHGaussian,
						spBlurVGaussian,
				...
				private:
					...
					opengl45::CVertexArrayImmutable *m_pDefaultVertexArray;
					opengl45::CProgramBase *m_pActiveProgramBase;
					opengl45::CProgramMini *m_pActiveProgramMini;
					opengl45::CProgramMain *m_pProgramMain;
					...
					void SetSubroutine(const SUBROUTINE_PATTERN pattern);
					...
					bool CheckDrawAllowed(const AnsiString &function, const int line);
				protected:
				...
				public:
					...
					CRenderer(
						...
						const Version2 &max_version = Version2{ 3, 0 },
