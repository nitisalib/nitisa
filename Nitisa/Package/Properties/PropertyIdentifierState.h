...
#include "../Interfaces/IPropertyIdentifierState.h"
#include <iostream>
#include <map>
...
namespace nitisa
{
	...
	class CPropertyIdentifierState :public virtual IPropertyIdentifierState, public CPropertyState
	{
	public:
