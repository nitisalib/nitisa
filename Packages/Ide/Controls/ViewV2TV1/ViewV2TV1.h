...
namespace nitisa
{
	...
	namespace ide
	{
		class CViewV2TV1 :public virtual IViewV2TV1, public CControl
		{
			friend class CViewV2TV1Service;
		public:
			enum class State
			{
				Normal,
		...
		public:
			...
			CViewV2TV1();
			CViewV2TV1(IForm *parent);
			CViewV2TV1(IControl *parent);
