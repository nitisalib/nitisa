...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxRectB;

		class CPropertyHandlerRectB :public CPropertyHandlerModal
		{
		private:
			...
			IFormRectB *getForm();
			CDialogBoxRectB *getDialogBox();
			void setDialogData(const RectB &value);
		protected:
		...
		public:
			...
			CPropertyHandlerRectB(IPackage *package);
		};
	}
}