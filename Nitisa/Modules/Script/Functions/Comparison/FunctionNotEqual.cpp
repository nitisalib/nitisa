...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionNotEqual::CFunctionNotEqual(IErrorListener *error_listener, IFunction *operand1, IFunction *operand2) :
		...
		void CFunctionNotEqual::BeforeRelease()
		{
			if (m_pOperand1)
				m_pOperand1->Release();
			if (m_pOperand2)
