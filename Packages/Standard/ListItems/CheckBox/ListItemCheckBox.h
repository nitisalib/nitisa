...
namespace nitisa
{
	...
	namespace standard
	{
		...
		private:
			...
			{
			private:
				CListItemCheckBox *m_pControl;
			public:
				void NotifyOnChange() override;

				CGradientListener(CListItemCheckBox *control);
			};
		private:
			...
			RectF m_aImagePadding[(int)State::Disabled + 1];
