...
namespace nitisa
{
	...
	namespace charts
	{
		...
		class CSemiDoughnutChart :public virtual ISemiDoughnutChart, public CCustomRadialChart
		{
		private:
		...
		public:
			...
			CSemiDoughnutChart();
			CSemiDoughnutChart(IForm *parent);
			CSemiDoughnutChart(IControl *parent);
