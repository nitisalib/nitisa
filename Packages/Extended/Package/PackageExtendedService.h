...
namespace nitisa
{
	...
	namespace extended
	{
		class CPackageExtended;

		class CPackageExtendedService :public virtual IPackageService
		{
		private:
			CPackageExtended *m_pPackage;
		public:
			...
			CPackageExtendedService(CPackageExtended *package);
			virtual ~CPackageExtendedService() = default;
		};
	}
}