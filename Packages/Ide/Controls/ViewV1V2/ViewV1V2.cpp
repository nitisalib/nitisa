...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewV1V2::CViewV1V2() :
			CControl(L"ViewV1V2", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
		...
		{
			setService(new CViewV1V2Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewV1V2::CViewV1V2(IForm *parent) :
			CViewV1V2()
		{
			setForm(parent);
		}

		CViewV1V2::CViewV1V2(IControl *parent) :
			CViewV1V2()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewV1V2::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewV1V2::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewV1V2 getters
		bool CViewV1V2::isResizable()
		{
			return m_bResizable;
		}

		float CViewV1V2::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewV1V2::getSeparatorV()
		{
			return m_fSeparatorV;
		}
	#pragma endregion

	#pragma region IViewV1V2 setters
		bool CViewV1V2::setResizable(const bool value)
		{
		...
		bool CViewV1V2::setSeparatorH(const float value)
		{
		...
		bool CViewV1V2::setSeparatorV(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 1) };
	...
	#pragma region Getters
		CViewV1V2::View CViewV1V2::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewV1V2::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewV1V2::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewV1V2::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewV1V2::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewV1V2::setActiveView(const View value)
		{
		...
		bool CViewV1V2::setBorderWidth(const float value)
		{
		...
		bool CViewV1V2::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewV1V2::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewV1V2::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewV1V2::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewV1V2::CalculateSeparatorHRect()
		{
		...
		RectF CViewV1V2::CalculateSeparatorVRect()
		{
		...
		RectF CViewV1V2::CalculateLeftViewRect()
		{
		...
		RectF CViewV1V2::CalculateTopViewRect()
		{
		...
		RectF CViewV1V2::CalculateBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewV1V2::CalculateLeftClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewV1V2::CalculateTopClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewV1V2::CalculateBottomClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
