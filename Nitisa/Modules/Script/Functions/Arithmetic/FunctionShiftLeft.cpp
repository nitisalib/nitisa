...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionShiftLeft::CFunctionShiftLeft(IErrorListener *error_listener, IFunction *operand1, IFunction *operand2) :
		...
		void CFunctionShiftLeft::BeforeRelease()
		{
			if (m_pOperand1)
				m_pOperand1->Release();
			if (m_pOperand2)
