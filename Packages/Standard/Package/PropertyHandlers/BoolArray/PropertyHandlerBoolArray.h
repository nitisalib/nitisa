...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxBoolArray;

		class CPropertyHandlerBoolArray :public standard::CPropertyHandlerModal
		{
		private:
			...
			IFormBoolArray *getForm();
			CDialogBoxBoolArray *getDialogBox();
			void setDialogValue(const BoolArray &value, const int min_count);
		protected:
		...
		public:
			...
			CPropertyHandlerBoolArray(IPackage *package);
		};
	}
}