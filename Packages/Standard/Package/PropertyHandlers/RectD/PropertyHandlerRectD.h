...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxRectD;

		class CPropertyHandlerRectD :public CPropertyHandlerModal
		{
		private:
			...
			IFormRectD *getForm();
			CDialogBoxRectD *getDialogBox();
			void setDialogData(const RectD &value, const bool has_min, const bool has_max, const double min, const double max);
		protected:
		...
		public:
			...
			CPropertyHandlerRectD(IPackage *package);
		};
	}
}