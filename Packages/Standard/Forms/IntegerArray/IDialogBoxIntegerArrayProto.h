...
//             namespace standard
//             {
//                 class CDialogBoxIntegerArrayProto : public IDialogBoxIntegerArrayProto // Derive your widget from class from this file
//                 {
...
//
//                     CDialogBoxIntegerArrayProto(); // Declare constructor
//                 };
//             }
//         }
//
//     DialogBoxIntegerArrayProto.cpp:
//         #include "DialogBoxIntegerArrayProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CDialogBoxIntegerArrayProto::CDialogBoxIntegerArrayProto(): // Implement constructor of your widget
//                     IDialogBoxIntegerArrayProto(L"DialogBoxIntegerArrayProto", true, true, false, false, DesignDPI) // Here you may add your service implementation as the latest parameter
//                 {
//                     // Insert your code here
//                 }
//
//                 void CDialogBoxIntegerArrayProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//
//                 Color CDialogBoxIntegerArrayProto::getBackgroundColor() // Implement IDialogBox's getBackgroundColor() methods
//                 {
...
namespace nitisa
{
	...
	namespace standard
	{
		class IDialogBoxIntegerArrayProto : public CDialogBoxEx
		{
		public:
			class IDialogBoxIntegerArrayProtoService: public CDialogBoxExService
			{
			private:
				IDialogBoxIntegerArrayProto *m_pControl;
			public:
				...
				IDialogBoxIntegerArrayProtoService(IDialogBoxIntegerArrayProto *control) : CDialogBoxExService(control),
					m_pControl{ control }
				{
		...
		protected:
			...
			virtual void FormIntegerArrayProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pListBoxArray->OnSelect = [](IControl *sender, IListItem *item)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ListBoxArray_OnSelect(sender, item); };

				m_pButtonAdd->setName(L"ButtonAdd");
				m_pButtonAdd->getTransform()->Translate(192.0f, 32.0f, 0.0f);
				m_pButtonAdd->setTabOrder(4);
				m_pButtonAdd->setCaption(UTF8ToString("Add"));
				m_pButtonAdd->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonAdd_OnClick(sender); };
				...
				m_pButtonUpdate->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonUpdate_OnClick(sender); };
				...
				m_pButtonDelete->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonDelete_OnClick(sender); };
				...
				m_pButtonClear->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonClear_OnClick(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { parent<IDialogBoxIntegerArrayProto*, false>(sender)->ButtonCancel_OnClick(sender); };
		...
		public:
			IDialogBoxIntegerArrayProto(const String &class_name, const bool accept_form, const bool accept_control, const bool accept_focus, const bool tab_stop, const Point &design_dpi = DesignDPI, IDialogBoxService *service = nullptr) :
				CDialogBoxEx(class_name, accept_form, accept_control, accept_focus, tab_stop, design_dpi, service ? service : new IDialogBoxIntegerArrayProtoService(this)),
				...
				m_pLabelMaxValue{ nullptr }
			{
				...
				setName(L"DialogBoxIntegerArrayProto");
				setCaption(UTF8ToString("Manage integer-array"));
				...
				setHasSizeBox(false);
				Initialize();
				OnKeyUp = [](IControl *sender, const MessageKey &m, bool &processed)->void { cast<IDialogBoxIntegerArrayProto*>(sender)->FormIntegerArrayProto_OnKeyUp(sender, m, processed); };
			}
