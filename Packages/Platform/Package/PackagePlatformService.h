...
namespace nitisa
{
	...
	namespace platform
	{
		class CPackagePlatform;

		class CPackagePlatformService :public virtual IPackageService
		{
		private:
			CPackagePlatform *m_pPackage;
		public:
			...
			CPackagePlatformService(CPackagePlatform *package);
			virtual ~CPackagePlatformService() = default;
		};
	}
}