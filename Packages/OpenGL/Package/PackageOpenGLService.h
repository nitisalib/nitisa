...
namespace nitisa
{
	...
	namespace opengl
	{
		class CPackageOpenGL;

		class CPackageOpenGLService :public virtual IPackageService
		{
		private:
			CPackageOpenGL *m_pPackage;
		public:
			...
			CPackageOpenGLService(CPackageOpenGL *package);
			virtual ~CPackageOpenGLService() = default;
		};
	}
}