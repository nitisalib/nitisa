...
//             namespace standard
//             {
//                 class CDialogBoxPointFProto : public IDialogBoxPointFProto // Derive your widget from class from this file
//                 {
...
//
//                     CDialogBoxPointFProto(); // Declare constructor
//                 };
//             }
//         }
//
//     DialogBoxPointFProto.cpp:
//         #include "DialogBoxPointFProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CDialogBoxPointFProto::CDialogBoxPointFProto(): // Implement constructor of your widget
//                     IDialogBoxPointFProto(L"DialogBoxPointFProto", true, true, false, false, DesignDPI) // Here you may add your service implementation as the latest parameter
//                 {
//                     // Insert your code here
//                 }
//
//                 void CDialogBoxPointFProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//
//                 Color CDialogBoxPointFProto::getBackgroundColor() // Implement IDialogBox's getBackgroundColor() methods
//                 {
...
namespace nitisa
{
	...
	namespace standard
	{
		class IDialogBoxPointFProto : public CDialogBoxEx
		{
		public:
			class IDialogBoxPointFProtoService: public CDialogBoxExService
			{
			private:
				IDialogBoxPointFProto *m_pControl;
			public:
				...
				IDialogBoxPointFProtoService(IDialogBoxPointFProto *control) : CDialogBoxExService(control),
					m_pControl{ control }
				{
		...
		protected:
			...
			virtual void FormPointFProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pEditX->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointFProto*, false>(sender)->EditX_OnKillFocus(sender); };
				...
				m_pEditY->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointFProto*, false>(sender)->EditY_OnKillFocus(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointFProto*, false>(sender)->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointFProto*, false>(sender)->ButtonCancel_OnClick(sender); };


			}

		public:
			IDialogBoxPointFProto(const String &class_name, const bool accept_form, const bool accept_control, const bool accept_focus, const bool tab_stop, const Point &design_dpi = DesignDPI, IDialogBoxService *service = nullptr) :
				CDialogBoxEx(class_name, accept_form, accept_control, accept_focus, tab_stop, design_dpi, service ? service : new IDialogBoxPointFProtoService(this)),
				m_pLabelX{ nullptr },
				m_pEditX{ nullptr },
				m_pLabelY{ nullptr },
				m_pEditY{ nullptr },
				...
				m_pButtonCancel{ nullptr }
			{
				...
				setName(L"DialogBoxPointFProto");
				setCaption(UTF8ToString("Point(float)"));
				...
				setHasSizeBox(false);
				Initialize();
				OnKeyUp = [](IControl *sender, const MessageKey &m, bool &processed)->void { cast<IDialogBoxPointFProto*>(sender)->FormPointFProto_OnKeyUp(sender, m, processed); };
			}
