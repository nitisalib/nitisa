...
#include "../StatusPanel/ListItemStatusPanel.h"
#include "../IListItemStatusPanelLabel.h"
...
namespace nitisa
{
	...
	namespace standard
	{
		...
		private:
			...
			{
			private:
				CListItemStatusPanelLabel *m_pControl;
			public:
				void NotifyOnChange() override;

				CGradientListener(CListItemStatusPanelLabel *control);
			};
		private:
