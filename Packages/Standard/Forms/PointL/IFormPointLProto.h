...
// For example:
//     FormPointLProto.h:
//         #include "IFormPointLProto.h" // Include this file
//
//         namespace nitisa
//         {
//             class IControl;
...
//             namespace standard
//             {
//                 class CFormPointLProto : public IFormPointLProto // Derive your form from class from this file
//                 {
...
//                 public:
//                     CFormPointLProto(); // Declare constructor
//                 };
//             }
//         }
//
...
//         #include "FormPointLProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CFormPointLProto::CFormPointLProto(): // Implement constructor of your form
//                     IFormPointLProto(new standard::windows::CWindow(), new standard::windows::opengl::CRenderer(false, 0))
//                 {
//                     // Insert your code here
//                 }
//
//                 void CFormPointLProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//             }
...
namespace nitisa
{
	...
	namespace standard
	{
		class IFormPointLProto : public CForm
		{
		protected:
			// Controls
			CLabel *m_pLabelX;
		...
		protected:
			...
			virtual void FormPointLProto_OnKeyUp(IForm *sender, const MessageKey &m) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pEditX->OnKillFocus = [](IControl *sender)->void { cast<IFormPointLProto*>(sender->getForm())->EditX_OnKillFocus(sender); };
				...
				m_pEditY->OnKillFocus = [](IControl *sender)->void { cast<IFormPointLProto*>(sender->getForm())->EditY_OnKillFocus(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { cast<IFormPointLProto*>(sender->getForm())->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { cast<IFormPointLProto*>(sender->getForm())->ButtonCancel_OnClick(sender); };


			}

		public:
			IFormPointLProto(IWindow *window, IRenderer *renderer, const String &class_name = L"FormPointLProto", const CreateParams *params = nullptr) :
				...
				m_pButtonCancel{ nullptr }
			{
				if (window)
				{
					...
					OnKeyUp = [](IForm *sender, const MessageKey &m)->void { cast<IFormPointLProto*>(sender)->FormPointLProto_OnKeyUp(sender, m); };
				}
			}
		};
	}
