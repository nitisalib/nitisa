...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxPointB;

		class CPropertyHandlerPointB :public CPropertyHandlerModal
		{
		private:
			...
			IFormPointB *getForm();
			CDialogBoxPointB *getDialogBox();
			void setDialogPoint(const PointB &value);
		protected:
		...
		public:
			...
			CPropertyHandlerPointB(IPackage *package);
		};
	}
}