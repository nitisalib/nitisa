...
namespace nitisa
{
	namespace script
	{
		class CReaderUpperCase :public virtual IReader, public CReleasable
		{
		private:
			String m_sSource;
		public:
			...
			CReaderUpperCase();
			CReaderUpperCase(const String &source);
			CReaderUpperCase(const String &source, const size_t min, const size_t max);
		};
	}
}