...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionBitwiseNot::CFunctionBitwiseNot(IErrorListener *error_listener, IFunction *operand) :
		...
		void CFunctionBitwiseNot::BeforeRelease()
		{
			if (m_pOperand)
				m_pOperand->Release();
		}
