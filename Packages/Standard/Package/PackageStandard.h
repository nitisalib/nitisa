...
// Copyright © 2021Nitisa. All rights reserved.
...
namespace nitisa
{
	...
	namespace standard
	{
		class CPackageStandardService;

		class CPackageStandard :public virtual IPackage
		{
			friend CPackageStandardService;
		private:
			struct COMPONENT
			{
