...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewV2BV1::CViewV2BV1() :
			CControl(L"ViewV2BV1", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
			m_fSeparatorX{ 0.25f },
		...
		{
			setService(new CViewV2BV1Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewV2BV1::CViewV2BV1(IForm *parent) :
			CViewV2BV1()
		{
			setForm(parent);
		}

		CViewV2BV1::CViewV2BV1(IControl *parent) :
			CViewV2BV1()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewV2BV1::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewV2BV1::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewV2XV1 getters
		bool CViewV2BV1::isResizable()
		{
			return m_bResizable;
		}

		float CViewV2BV1::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewV2BV1::getSeparatorV()
		{
			return m_fSeparatorV;
		}

		float CViewV2BV1::getSeparatorX()
		{
	...
	#pragma region IViewV2XV1 setters
		bool CViewV2BV1::setResizable(const bool value)
		{
		...
		bool CViewV2BV1::setSeparatorH(const float value)
		{
		...
		bool CViewV2BV1::setSeparatorV(const float value)
		{
		...
		bool CViewV2BV1::setSeparatorX(const float value)
		{
	...
	#pragma region Getters
		CViewV2BV1::View CViewV2BV1::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewV2BV1::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewV2BV1::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewV2BV1::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewV2BV1::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewV2BV1::setActiveView(const View value)
		{
		...
		bool CViewV2BV1::setBorderWidth(const float value)
		{
		...
		bool CViewV2BV1::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewV2BV1::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewV2BV1::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewV2BV1::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewV2BV1::CalculateSeparatorHRect()
		{
		...
		RectF CViewV2BV1::CalculateSeparatorVRect()
		{
		...
		RectF CViewV2BV1::CalculateSeparatorXRect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewV2BV1::CalculateRightViewRect()
		{
		...
		RectF CViewV2BV1::CalculateLeftTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewV2BV1::CalculateLeftBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorX - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewV2BV1::CalculateRightBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewV2BV1::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewV2BV1::CalculateLeftTopClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewV2BV1::CalculateLeftBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorX - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewV2BV1::CalculateRightBottomClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
