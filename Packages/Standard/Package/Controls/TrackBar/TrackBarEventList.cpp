...
namespace nitisa
{
	namespace standard
	{
		CTrackBarEventList::CTrackBarEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}ITrackBar *sender", L"sender"))
				->AddForwardDeclaration(L"class ITrackBar;", L"Standard/Controls/ITrackBar.h", L"standard");
		}
	}
}