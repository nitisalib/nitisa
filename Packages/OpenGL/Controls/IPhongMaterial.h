...
namespace nitisa
{
	...
	namespace opengl
	{
		class IPhongMaterial :public virtual IMaterialControl
		{
		protected:
			IPhongMaterial() = default;
			~IPhongMaterial() = default;
			IPhongMaterial(const IPhongMaterial &other) = delete;
			IPhongMaterial(IPhongMaterial &&other) = delete;
			IPhongMaterial &operator=(const IPhongMaterial &other) = delete;
			IPhongMaterial &operator=(IPhongMaterial &&other) = delete;
		public:
