...
#include "../Interfaces/IPropertyTextState.h"
#include <iostream>
#include <map>
...
namespace nitisa
{
	...
	class CPropertyTextState :public virtual IPropertyTextState, public CPropertyState
	{
	public:
	...
	public:
		...
		// IPropertyTextState getters
		String getValue(const String &state) override;

		// IPropertyTextState setters
