...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CListItemLabelService :public CListItemService
		{
		private:
			CListItemLabel *m_pListItem;
			bool m_bDown;
			Point m_sDPI;
		public:
			CListItemLabelService(CListItemLabel *listitem);
			...
			void Render(const Mat4f &matrix4, const Block *block, const bool last_pass, ITexture **clip) override;
