...
namespace nitisa
{
	...
	namespace ide
	{
		class CViewH2RH1 :public virtual IViewH2RH1, public CControl
		{
			friend class CViewH2RH1Service;
		public:
			enum class State
			{
				Normal,
		...
		public:
			...
			CViewH2RH1();
			CViewH2RH1(IForm *parent);
			CViewH2RH1(IControl *parent);
