...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionInt64::CFunctionInt64(IErrorListener *error_listener, IFunction *operand) :
			CFunction(L"__cast(int64)", error_listener),
			m_pOperand{ operand }
		{
			m_pResult = &m_sResult;
		}

		void CFunctionInt64::BeforeRelease()
		{
			if (m_pOperand)
				m_pOperand->Release();
		}
