...
//             namespace standard
//             {
//                 class CDialogBoxPointProto : public IDialogBoxPointProto // Derive your widget from class from this file
//                 {
...
//
//                     CDialogBoxPointProto(); // Declare constructor
//                 };
//             }
//         }
//
//     DialogBoxPointProto.cpp:
//         #include "DialogBoxPointProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CDialogBoxPointProto::CDialogBoxPointProto(): // Implement constructor of your widget
//                     IDialogBoxPointProto(L"DialogBoxPointProto", true, true, false, false, DesignDPI) // Here you may add your service implementation as the latest parameter
//                 {
//                     // Insert your code here
//                 }
//
//                 void CDialogBoxPointProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//
//                 Color CDialogBoxPointProto::getBackgroundColor() // Implement IDialogBox's getBackgroundColor() methods
//                 {
...
namespace nitisa
{
	...
	namespace standard
	{
		class IDialogBoxPointProto : public CDialogBoxEx
		{
		public:
			class IDialogBoxPointProtoService: public CDialogBoxExService
			{
			private:
				IDialogBoxPointProto *m_pControl;
			public:
				...
				IDialogBoxPointProtoService(IDialogBoxPointProto *control) : CDialogBoxExService(control),
					m_pControl{ control }
				{
		...
		protected:
			...
			virtual void FormPointProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pEditX->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointProto*, false>(sender)->EditX_OnKillFocus(sender); };
				...
				m_pEditY->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointProto*, false>(sender)->EditY_OnKillFocus(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointProto*, false>(sender)->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointProto*, false>(sender)->ButtonCancel_OnClick(sender); };


			}

		public:
			IDialogBoxPointProto(const String &class_name, const bool accept_form, const bool accept_control, const bool accept_focus, const bool tab_stop, const Point &design_dpi = DesignDPI, IDialogBoxService *service = nullptr) :
				CDialogBoxEx(class_name, accept_form, accept_control, accept_focus, tab_stop, design_dpi, service ? service : new IDialogBoxPointProtoService(this)),
				m_pLabelX{ nullptr },
				m_pEditX{ nullptr },
				m_pLabelY{ nullptr },
				m_pEditY{ nullptr },
				...
				m_pButtonCancel{ nullptr }
			{
				...
				setHasSizeBox(false);
				Initialize();
				OnKeyUp = [](IControl *sender, const MessageKey &m, bool &processed)->void { cast<IDialogBoxPointProto*>(sender)->FormPointProto_OnKeyUp(sender, m, processed); };
			}
