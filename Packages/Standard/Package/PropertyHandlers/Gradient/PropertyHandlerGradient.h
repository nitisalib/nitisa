...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxGradient;

		class CPropertyHandlerGradient :public CPropertyHandlerModal
		{
		private:
			...
			IFormGradient *getForm();
			CDialogBoxGradient *getDialogBox();
			void setDialogData(Gradient &value);
		protected:
		...
		public:
			...
			CPropertyHandlerGradient(IPackage *package);
		};
	}
}