...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CFunctionPostfixIncrement::CFunctionPostfixIncrement(IErrorListener *error_listener, IFunction *operand, IFunction *modify) :
		...
		void CFunctionPostfixIncrement::BeforeRelease()
		{
			if (m_pOperand)
				m_pOperand->Release();
		}
	...
	#pragma region IFunction methods
		bool CFunctionPostfixIncrement::Run()
		{
			if (!m_pOperand)
			{
				if (m_pErrorListener)
