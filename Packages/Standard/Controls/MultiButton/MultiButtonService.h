...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CMultiButtonService :public virtual IComponentItemListService, public CControlService
		{
		private:
		...
		public:
			...
			// IComponentItemListService methods
			bool MoveItem(IListItem *item, const int before) override;

			CMultiButtonService(CMultiButton *control);
		};
	}
}