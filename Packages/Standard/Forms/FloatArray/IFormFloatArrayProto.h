...
// For example:
//     FormFloatArrayProto.h:
//         #include "IFormFloatArrayProto.h" // Include this file
//
//         namespace nitisa
//         {
//             class IControl;
...
//             namespace standard
//             {
//                 class CFormFloatArrayProto : public IFormFloatArrayProto // Derive your form from class from this file
//                 {
...
//                 public:
//                     CFormFloatArrayProto(); // Declare constructor
//                 };
//             }
//         }
//
//     FormFloatArrayProto.cpp:
...
//         #include "FormFloatArrayProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CFormFloatArrayProto::CFormFloatArrayProto(): // Implement constructor of your form
//                     IFormFloatArrayProto(new standard::windows::CWindow(), new standard::windows::opengl::CRenderer(false, 0))
//                 {
//                     // Insert your code here
//                 }
//
//                 void CFormFloatArrayProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//             }
...
namespace nitisa
{
	...
	namespace standard
	{
		class IFormFloatArrayProto : public CForm
		{
		protected:
			// Controls
		...
		protected:
			...
			virtual void FormFloatArrayProto_OnKeyUp(IForm *sender, const MessageKey &m) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pListBoxArray->OnSelect = [](IControl *sender, IListItem *item)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ListBoxArray_OnSelect(sender, item); };

				m_pButtonAdd->setName(L"ButtonAdd");
				m_pButtonAdd->getTransform()->Translate(192.0f, 32.0f, 0.0f);
				m_pButtonAdd->setTabOrder(4);
				m_pButtonAdd->setCaption(UTF8ToString("Add"));
				m_pButtonAdd->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonAdd_OnClick(sender); };
				...
				m_pButtonUpdate->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonUpdate_OnClick(sender); };
				...
				m_pButtonDelete->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonDelete_OnClick(sender); };
				...
				m_pButtonClear->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonClear_OnClick(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { cast<IFormFloatArrayProto*>(sender->getForm())->ButtonCancel_OnClick(sender); };
		...
		public:
			IFormFloatArrayProto(IWindow *window, IRenderer *renderer, const String &class_name = L"FormFloatArrayProto", const CreateParams *params = nullptr) :
				...
				m_pLabelMaxValue{ nullptr }
			{
				if (window)
				{
					...
					OnKeyUp = [](IForm *sender, const MessageKey &m)->void { cast<IFormFloatArrayProto*>(sender)->FormFloatArrayProto_OnKeyUp(sender, m); };
				}
			}
		};
	}
