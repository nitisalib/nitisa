...
namespace nitisa
{
	namespace standard
	{
		CPopupMenuEventList::CPopupMenuEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			...
			Add(new CEvent(this, control, L"OnDeactivateItem", L"IControl *sender, IListItem *item", L"sender, item"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"")
				->AddForwardDeclaration(L"class IListItem;", L"Nitisa/Interfaces/IListItem.h", L"");
			Add(new CEvent(this, control, L"OnDeleteItem", L"IControl *sender", L"sender"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"");
			Add(new CEvent(this, control, L"OnDeleteItems", L"IControl *sender", L"sender"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"");
		}
	}
}