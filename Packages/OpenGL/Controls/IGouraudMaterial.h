...
namespace nitisa
{
	...
	namespace opengl
	{
		...
		{
		protected:
			IGouraudMaterial() = default;
			~IGouraudMaterial() = default;
			IGouraudMaterial(const IGouraudMaterial &other) = delete;
			IGouraudMaterial(IGouraudMaterial &&other) = delete;
			IGouraudMaterial &operator=(const IGouraudMaterial &other) = delete;
			IGouraudMaterial &operator=(IGouraudMaterial &&other) = delete;
		public:
