...
namespace nitisa
{
	namespace standard
	{
		CTimePickerEventList::CTimePickerEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}ITimePicker *sender", L"sender"))
				->AddForwardDeclaration(L"class ITimePicker;", L"Standard/Controls/ITimePicker.h", L"standard");
		}
	}
}