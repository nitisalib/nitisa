	...
	namespace script
	{
		namespace cppdoc
		{
			namespace models
			{
				...
				class CNamespaceAlias :public TDbActiveRecord<CNamespaceAlias>, public virtual CActiveRecord
				{
				public:
					...
					TDbAttribute<String> NamespaceName;
					TDbAttribute<uint> NamespaceId;

					TDbRelation<CEntity> Entity;
					TDbRelation<CEntity> Namespace;
