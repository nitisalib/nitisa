...
#include "IDialogBoxTransformProto.h"
...
namespace nitisa
{
	...
	namespace standard
	{
		...
		{
		private:
			class CDialogBoxTransformService :public IDialogBoxTransformProtoService
			{
			private:
				CDialogBoxTransform * m_pControl;
			public:
				// Application notifications
				void NotifyOnTranslateChange() override;

				CDialogBoxTransformService(CDialogBoxTransform *control);
			};
		private:
			Transform m_sValue;
			bool m_bTx;
		...
		protected:
			void FormTransformProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed) override;
