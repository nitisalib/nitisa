...
namespace nitisa
{
	namespace standard
	{
		CIconButtonEventList::CIconButtonEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			...
			Add(new CEvent(this, control, L"OnClick", L"IControl *sender", L"sender"))
