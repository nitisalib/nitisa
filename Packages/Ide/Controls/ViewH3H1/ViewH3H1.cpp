...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH3H1::CViewH3H1() :
			CControl(L"ViewH3H1", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorV{ 0.5f },
		...
		{
			setService(new CViewH3H1Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH3H1::CViewH3H1(IForm *parent) :
			CViewH3H1()
		{
			setForm(parent);
		}

		CViewH3H1::CViewH3H1(IControl *parent) :
			CViewH3H1()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewH3H1::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewH3H1::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewH3H1 getters
		bool CViewH3H1::isResizable()
		{
			return m_bResizable;
		}

		float CViewH3H1::getSeparatorV()
		{
			return m_fSeparatorV;
		}

		float CViewH3H1::getSeparatorH1()
		{
			return m_fSeparatorH1;
		}

		float CViewH3H1::getSeparatorH2()
		{
			return m_fSeparatorH2;
		}
	#pragma endregion

	#pragma region IViewH3H1 setters
		bool CViewH3H1::setResizable(const bool value)
		{
		...
		bool CViewH3H1::setSeparatorV(const float value)
		{
		...
		bool CViewH3H1::setSeparatorH1(const float value)
		{
		...
		bool CViewH3H1::setSeparatorH2(const float value)
		{
	...
	#pragma region Getters
		CViewH3H1::View CViewH3H1::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH3H1::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH3H1::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH3H1::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH3H1::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH3H1::setActiveView(const View value)
		{
		...
		bool CViewH3H1::setBorderWidth(const float value)
		{
		...
		bool CViewH3H1::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH3H1::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH3H1::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH3H1::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH3H1::CalculateSeparatorVRect()
		{
		...
		RectF CViewH3H1::CalculateSeparatorH1Rect()
		{
		...
		RectF CViewH3H1::CalculateSeparatorH2Rect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f), 0, 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.Right = result.Left + m_fSeparatorWidth;
			return result;
		}

		RectF CViewH3H1::CalculateLeftViewRect()
		{
		...
		RectF CViewH3H1::CalculateMiddleViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH3H1::CalculateRightViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH3H1::CalculateBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH3H1::CalculateLeftClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH3H1::CalculateMiddleClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH3H1::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH2 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH3H1::CalculateBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
