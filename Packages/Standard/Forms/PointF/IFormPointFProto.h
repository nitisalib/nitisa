...
// For example:
//     FormPointFProto.h:
//         #include "IFormPointFProto.h" // Include this file
//
//         namespace nitisa
//         {
//             class IControl;
...
//             namespace standard
//             {
//                 class CFormPointFProto : public IFormPointFProto // Derive your form from class from this file
//                 {
...
//                 public:
//                     CFormPointFProto(); // Declare constructor
//                 };
//             }
//         }
//
...
//         #include "FormPointFProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CFormPointFProto::CFormPointFProto(): // Implement constructor of your form
//                     IFormPointFProto(new standard::windows::CWindow(), new standard::windows::opengl::CRenderer(false, 0))
//                 {
//                     // Insert your code here
//                 }
//
//                 void CFormPointFProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//             }
...
namespace nitisa
{
	...
	namespace standard
	{
		class IFormPointFProto : public CForm
		{
		protected:
			// Controls
			CLabel *m_pLabelX;
		...
		protected:
			...
			virtual void FormPointFProto_OnKeyUp(IForm *sender, const MessageKey &m) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pEditX->OnKillFocus = [](IControl *sender)->void { cast<IFormPointFProto*>(sender->getForm())->EditX_OnKillFocus(sender); };
				...
				m_pEditY->OnKillFocus = [](IControl *sender)->void { cast<IFormPointFProto*>(sender->getForm())->EditY_OnKillFocus(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { cast<IFormPointFProto*>(sender->getForm())->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { cast<IFormPointFProto*>(sender->getForm())->ButtonCancel_OnClick(sender); };


			}

		public:
			IFormPointFProto(IWindow *window, IRenderer *renderer, const String &class_name = L"FormPointFProto", const CreateParams *params = nullptr) :
				...
				m_pButtonCancel{ nullptr }
			{
				if (window)
				{
					...
					OnKeyUp = [](IForm *sender, const MessageKey &m)->void { cast<IFormPointFProto*>(sender)->FormPointFProto_OnKeyUp(sender, m); };
				}
			}
		};
	}
