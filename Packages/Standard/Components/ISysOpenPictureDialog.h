...
namespace nitisa
{
	namespace standard
	{
		class ISysOpenPictureDialog :public virtual IComponent
		{
		protected:
			ISysOpenPictureDialog() = default;
			~ISysOpenPictureDialog() = default;
			ISysOpenPictureDialog(const ISysOpenPictureDialog &other) = delete;
			ISysOpenPictureDialog(ISysOpenPictureDialog &&other) = delete;
			ISysOpenPictureDialog &operator=(const ISysOpenPictureDialog &other) = delete;
			ISysOpenPictureDialog &operator=(ISysOpenPictureDialog &&other) = delete;
		public:
