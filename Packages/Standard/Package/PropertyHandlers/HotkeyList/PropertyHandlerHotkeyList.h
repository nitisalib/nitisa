...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxHotkeyList;

		class CPropertyHandlerHotkeyList :public CPropertyHandlerModal
		{
		private:
			IProperty *m_pProperty;
			bool m_bDialogBoxAdjusted;

			IFormHotkeyList *getForm();
			CDialogBoxHotkeyList *getDialogBox();
			void setDialogData();
		protected:
		...
		public:
			...
			CPropertyHandlerHotkeyList(IPackage *package);
		};
	}
}