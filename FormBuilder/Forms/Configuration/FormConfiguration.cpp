...
namespace nitisa
{
	namespace fb
	{
		CFormConfiguration *FormConfiguration{ nullptr };

	#pragma region Constructor & destructor
		CFormConfiguration::CFormConfiguration() :
			IFormConfiguration(CWindow::Create(), CRenderer::Create()),
			m_bGlobal{ true }
		{
	...
	#pragma region Events
		void CFormConfiguration::FormSettings_OnKeyDown(IForm *sender, const MessageKey &m)
		{
			switch (m.Key)
			{
			case Key::Escape:
		...
		void CFormConfiguration::PanelGridColor_OnLeftMouseButtonDown(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelGridColor->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelGridColor->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::ButtonOk_OnClick(IControl *sender)
		{
			if (Validate())
			{
				m_bGlobal = true;
		...
		void CFormConfiguration::ButtonOkForm_OnClick(IControl *sender)
		{
			if (Validate())
			{
				m_bGlobal = false;
		...
		void CFormConfiguration::ButtonCancel_OnClick(IControl *sender)
		{
			setModalResult(ModalResult::Cancel);
		}

		void CFormConfiguration::PanelSelectionBorderColor_OnLeftMouseButtonDown(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelSelectionBorderColor->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelSelectionBorderColor->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::PanelSelectionBackgroundColor_OnLeftMouseButtonDown(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelSelectionBackgroundColor->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelSelectionBackgroundColor->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::PanelHighlightBorderColorLeft_OnLeftMouseButtonUp(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelHighlightBorderColorLeft->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelHighlightBorderColorLeft->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::PanelHighlightBorderColorTop_OnLeftMouseButtonUp(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelHighlightBorderColorTop->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelHighlightBorderColorTop->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::PanelHighlightBorderColorRight_OnLeftMouseButtonUp(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelHighlightBorderColorRight->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelHighlightBorderColorRight->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::PanelHighlightBorderColorBottom_OnLeftMouseButtonUp(IControl *sender, const MessageMouse &m, bool &processed)
		{
			m_pColorDialog->setColor(m_pPanelHighlightBorderColorBottom->getBackgroundColor());
			if (m_pColorDialog->Execute())
				m_pPanelHighlightBorderColorBottom->setBackgroundColor(m_pColorDialog->getColor());
		}

		void CFormConfiguration::RadioButtonForm_OnChange(IControl *sender)
		{
			m_pDropDownDialogBox->setEnabled(m_pRadioButtonDialogBox->isChecked());
		}

		void CFormConfiguration::RadioButtonDialogBox_OnChange(IControl *sender)
		{
			m_pDropDownDialogBox->setEnabled(m_pRadioButtonDialogBox->isChecked());
		}
	#pragma endregion
	...
	#pragma region Getters
		bool CFormConfiguration::isGlobal() const
		{
			return m_bGlobal;
		}
	#pragma endregion
	...
	#pragma region Helpers
		bool CFormConfiguration::Validate()
		{
		...
		void CFormConfiguration::ToSettings(SETTINGS &dst)
		{
		...
		void CFormConfiguration::FromSettings(const SETTINGS &src)
		{
		...
		void CFormConfiguration::AddDialogBox(const String &name, const String &caption)
		{
