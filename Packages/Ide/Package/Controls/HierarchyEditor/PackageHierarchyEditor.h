...
#include "Standard/Package/Controls/TreeView/PackageCustomTreeView.h"
...
namespace nitisa
{
	...
	namespace ide
	{
		class CPackageHierarchyEditor :public standard::CPackageCustomTreeView
		{
		private:
			const Image m_cIcon;
		public:
			...
			CPackageHierarchyEditor(IPackage *package);
		};
	}
}