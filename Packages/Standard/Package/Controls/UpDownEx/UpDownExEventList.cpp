...
namespace nitisa
{
	namespace standard
	{
		CUpDownExEventList::CUpDownExEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}IUpDownEx *sender", L"sender"))
				->AddForwardDeclaration(L"class IUpDownEx;", L"Standard/Controls/IUpDownEx.h", L"standard");
		}
	}
}