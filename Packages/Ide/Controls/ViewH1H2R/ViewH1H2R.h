...
namespace nitisa
{
	...
	namespace ide
	{
		class CViewH1H2R :public virtual IViewH1H2R, public CControl
		{
			friend class CViewH1H2RService;
		public:
			enum class State
			{
				Normal,
		...
		public:
			...
			CViewH1H2R();
			CViewH1H2R(IForm *parent);
			CViewH1H2R(IControl *parent);
