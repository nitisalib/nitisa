	...
	namespace script
	{
		namespace json
		{
			const Operators CTokenizer::Ops{
				...
				Operator{ L"\n", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // \n
				Operator{ L"\r", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // \r
				Operator{ L" ", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // space
				Operator{ L"\t", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // tab
				Operator{ L"\v", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // vertical 1tab
				Operator{ L"\f", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // form feed
				...
				Operator{ L"{", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_NO_SKIP, false, false, false, false, false, false, 0 }, // {
				Operator{ L"}", EmptyString, EmptyStringKeyValueArray, false, false, false, GROUP_NO_SKIP, false, false, false, false, false, false, 0 }, // }
				Operator{ L"//", L"\n", EmptyStringKeyValueArray, false, true, false, GROUP_SKIP, false, false, false, false, false, false, 0 }, // //
