					...
					m_bValid{ true }
				{
					*reinterpret_cast<GLuint*>(&m_hHandle) = program->Id;
					...
					if (m_bValid)
					{
						...
						m_pGraphics->Uniform1i(m_sBlock.SubroutineTest, m_sBlock.None);
						m_pGraphics->Uniform1i(m_sMask.SubroutineTest, m_sMask.None);
						m_pGraphics->Uniform1i(m_sBitmask.SubroutineBitmask, m_sBitmask.Bitmask_None);
						m_pGraphics->Uniform1i(m_sSpline.SubroutineSplineLimit, m_sSpline.None);
					}
				}
