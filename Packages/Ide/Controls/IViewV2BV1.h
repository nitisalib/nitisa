...
namespace nitisa
{
	namespace ide
	{
		/*
			...
			-------------------------------------------
		*/
		class IViewV2BV1 :public virtual IViewControl, public virtual IControl
		{
		protected:
			IViewV2BV1() = default;
			~IViewV2BV1() = default;
			IViewV2BV1(const IViewV2BV1 &other) = delete;
			IViewV2BV1(IViewV2BV1 &&other) = delete;
			IViewV2BV1 &operator=(const IViewV2BV1 &other) = delete;
			IViewV2BV1 &operator=(IViewV2BV1 &&other) = delete;
		public:
