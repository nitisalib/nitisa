...
namespace nitisa
{
	namespace standard
	{
		CCustomDropDownEventList::CCustomDropDownEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnSelect", L"IControl *sender, const int index", L"sender, index"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"");
		}
	}
}