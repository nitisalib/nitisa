...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxSelectListItem;

		class CPackageSelect :public virtual IDialogBoxListener, public CPackageControl
		{
		private:
		...
		private:
			...
			CDialogBoxSelectListItem *getDialogBox(IComponent *component);
		public:
			...
			CPackageSelect(IPackage *package);
		};
	}
}