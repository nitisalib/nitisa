...
namespace nitisa
{
	namespace standard
	{
		CSpeedButtonEventList::CSpeedButtonEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnDown", L"IControl *sender", L"sender"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"");
			Add(new CEvent(this, control, L"OnUp", L"IControl *sender", L"sender"))
				->AddForwardDeclaration(L"class IControl;", L"Nitisa/Interfaces/IControl.h", L"");
		}
	}
}