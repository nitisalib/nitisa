...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxRectL;

		class CPropertyHandlerRectL :public CPropertyHandlerModal
		{
		private:
			...
			IFormRectL *getForm();
			CDialogBoxRectL *getDialogBox();
			void setDialogData(const RectL &value, const bool has_min, const bool has_max, const long long min, const long long max);
		protected:
		...
		public:
			...
			CPropertyHandlerRectL(IPackage *package);
		};
	}
}