...
//             namespace standard
//             {
//                 class CDialogBoxPointLProto : public IDialogBoxPointLProto // Derive your widget from class from this file
//                 {
...
//
//                     CDialogBoxPointLProto(); // Declare constructor
//                 };
//             }
//         }
//
//     DialogBoxPointLProto.cpp:
//         #include "DialogBoxPointLProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CDialogBoxPointLProto::CDialogBoxPointLProto(): // Implement constructor of your widget
//                     IDialogBoxPointLProto(L"DialogBoxPointLProto", true, true, false, false, DesignDPI) // Here you may add your service implementation as the latest parameter
//                 {
//                     // Insert your code here
//                 }
//
//                 void CDialogBoxPointLProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//
//                 Color CDialogBoxPointLProto::getBackgroundColor() // Implement IDialogBox's getBackgroundColor() methods
//                 {
...
namespace nitisa
{
	...
	namespace standard
	{
		class IDialogBoxPointLProto : public CDialogBoxEx
		{
		public:
			class IDialogBoxPointLProtoService: public CDialogBoxExService
			{
			private:
				IDialogBoxPointLProto *m_pControl;
			public:
				...
				IDialogBoxPointLProtoService(IDialogBoxPointLProto *control) : CDialogBoxExService(control),
					m_pControl{ control }
				{
		...
		protected:
			...
			virtual void FormPointLProto_OnKeyUp(IControl *sender, const MessageKey &m, bool &processed) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pEditX->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointLProto*, false>(sender)->EditX_OnKillFocus(sender); };
				...
				m_pEditY->OnKillFocus = [](IControl *sender)->void { parent<IDialogBoxPointLProto*, false>(sender)->EditY_OnKillFocus(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointLProto*, false>(sender)->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { parent<IDialogBoxPointLProto*, false>(sender)->ButtonCancel_OnClick(sender); };


			}

		public:
			IDialogBoxPointLProto(const String &class_name, const bool accept_form, const bool accept_control, const bool accept_focus, const bool tab_stop, const Point &design_dpi = DesignDPI, IDialogBoxService *service = nullptr) :
				CDialogBoxEx(class_name, accept_form, accept_control, accept_focus, tab_stop, design_dpi, service ? service : new IDialogBoxPointLProtoService(this)),
				m_pLabelX{ nullptr },
				m_pEditX{ nullptr },
				m_pLabelY{ nullptr },
				m_pEditY{ nullptr },
				...
				m_pButtonCancel{ nullptr }
			{
				...
				setName(L"DialogBoxPointLProto");
				setCaption(UTF8ToString("Point(64-bit integer)"));
				...
				setHasSizeBox(false);
				Initialize();
				OnKeyUp = [](IControl *sender, const MessageKey &m, bool &processed)->void { cast<IDialogBoxPointLProto*>(sender)->FormPointLProto_OnKeyUp(sender, m, processed); };
			}
