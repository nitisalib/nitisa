...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CDialogBoxPointF;

		class CPropertyHandlerPointF :public CPropertyHandlerModal
		{
		private:
			...
			IFormPointF *getForm();
			CDialogBoxPointF *getDialogBox();
			void setDialogData(const PointF &value, const bool has_min, const bool has_max, const float min, const float max);
		protected:
		...
		public:
			...
			CPropertyHandlerPointF(IPackage *package);
		};
	}
}