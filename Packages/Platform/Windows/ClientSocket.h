	...
	namespace platform
	{
		namespace windows
		{
			...
			public:
				...
				ISocket::DataExist isDataExist(ISocket::ErrorType &error) override;

				CClientSocket(void *socket, const AnsiString &local_ip, const AnsiString &remote_ip, const int local_port, const int remote_port);
			};
		}
	}
}
