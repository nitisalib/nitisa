...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH1H2L::CViewH1H2L() :
			CControl(L"ViewH1H2L", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
			m_fSeparatorX{ 0.75f },
		...
		{
			setService(new CViewH1H2LService(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH1H2L::CViewH1H2L(IForm *parent) :
			CViewH1H2L()
		{
			setForm(parent);
		}

		CViewH1H2L::CViewH1H2L(IControl *parent) :
			CViewH1H2L()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewH1H2L::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewH1H2L::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewV2XV1 getters
		bool CViewH1H2L::isResizable()
		{
			return m_bResizable;
		}

		float CViewH1H2L::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewH1H2L::getSeparatorV()
		{
			return m_fSeparatorV;
		}

		float CViewH1H2L::getSeparatorX()
		{
	...
	#pragma region IViewV2XV1 setters
		bool CViewH1H2L::setResizable(const bool value)
		{
		...
		bool CViewH1H2L::setSeparatorH(const float value)
		{
		...
		bool CViewH1H2L::setSeparatorV(const float value)
		{
		...
		bool CViewH1H2L::setSeparatorX(const float value)
		{
	...
	#pragma region Getters
		CViewH1H2L::View CViewH1H2L::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH1H2L::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH1H2L::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH1H2L::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH1H2L::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH1H2L::setActiveView(const View value)
		{
		...
		bool CViewH1H2L::setBorderWidth(const float value)
		{
		...
		bool CViewH1H2L::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH1H2L::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH1H2L::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH1H2L::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH1H2L::CalculateSeparatorHRect()
		{
		...
		RectF CViewH1H2L::CalculateSeparatorVRect()
		{
		...
		RectF CViewH1H2L::CalculateSeparatorXRect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getHeight() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getWidth()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f), std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), 0 };
			result.Bottom = result.Top + m_fSeparatorWidth;
			return result;
		}

		RectF CViewH1H2L::CalculateTopViewRect()
		{
		...
		RectF CViewH1H2L::CalculateRightBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H2L::CalculateLeftTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH1H2L::CalculateLeftBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH1H2L::CalculateTopClientRect()
		{
			RectF result{ 0, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH1H2L::CalculateRightBottomClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H2L::CalculateLeftTopClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewH1H2L::CalculateLeftBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorX - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
