...
namespace nitisa
{
	...
	namespace standard
	{
		class CListItemMenuSeparator;

		class CListItemMenuSeparatorService :public CListItemMenuService
		{
		private:
			CListItemMenuSeparator *m_pItem;
		public:
			CListItemMenuSeparatorService(CListItemMenuSeparator *item);
