...
namespace nitisa
{
	...
	namespace standard
	{
		...
		class CPageControlService :public virtual IPageControlService, public virtual ITimerListener, public CControlService
		{
		private:
			CPageControl *m_pPage;
			bool m_bIgnoreChildShow;
			bool m_bIgnoreChildHide;
		...
		public:
			CPageControlService(CPageControl *page);
			...
			// TabSheet notifications
			void NotifyOnTabSheetChanged(ITabSheet *tab) override;
		};
	}
}