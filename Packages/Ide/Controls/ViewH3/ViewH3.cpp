...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH3::CViewH3() :
			CControl(L"ViewH3", true, true, true, false, false, false),
			m_bResizable{ true },
		...
		{
			setService(new CViewH3Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH3::CViewH3(IForm *parent) :
			CViewH3()
		{
			setForm(parent);
		}

		CViewH3::CViewH3(IControl *parent) :
			CViewH3()
		{
			setParent(parent);
		}
	...
	#pragma region IViewControl methods
		bool CViewH3::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewH3 getters
		bool CViewH3::isResizable()
		{
			return m_bResizable;
		}

		float CViewH3::getSeparator1()
		{
			return m_fSeparator1;
		}

		float CViewH3::getSeparator2()
		{
			return m_fSeparator2;
		}
	#pragma endregion

	#pragma region IViewH3 setters
		bool CViewH3::setResizable(const bool value)
		{
		...
		bool CViewH3::setSeparator1(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, m_fSeparator2 - m_fSeparatorWidth / ntl::Max<float>(1, getWidth())) };
		...
		bool CViewH3::setSeparator2(const float value)
		{
			float v{ ntl::Clamp<float>(value, m_fSeparator1 + m_fSeparatorWidth / ntl::Max<float>(1, getWidth()), 1) };
	...
	#pragma region Getters
		CViewH3::View CViewH3::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH3::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH3::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH3::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH3::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH3::setActiveView(const View value)
		{
		...
		bool CViewH3::setBorderWidth(const float value)
		{
		...
		bool CViewH3::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH3::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH3::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH3::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH3::CalculateSeparator1Rect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparator1 - m_fSeparatorWidth * 0.5f), 0, 0, getHeight() };
			result.Right = result.Left + m_fSeparatorWidth;
			return result;
		}

		RectF CViewH3::CalculateSeparator2Rect()
		{
			if (ntl::IsZero<float>(m_fSeparatorWidth) || getWidth() <= m_fSeparatorWidth * 2 || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparator2 - m_fSeparatorWidth * 0.5f), 0, 0, getHeight() };
			result.Right = result.Left + m_fSeparatorWidth;
			return result;
		}

		RectF CViewH3::CalculateLeftViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparator1 - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH3::CalculateMiddleViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparator1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, std::round(getWidth() * m_fSeparator2 - m_fSeparatorWidth * 0.5f), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH3::CalculateRightViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()))
				return RectF{ 0, 0, 0, 0 };
			RectF result{ std::round(getWidth() * m_fSeparator2 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), getHeight() };
			if (result.height() <= m_fBorderWidth * 2 || result.width() <= m_fBorderWidth * 2)
				return RectF{ 0, 0, 0, 0 };
			return result;
		}

		RectF CViewH3::CalculateLeftClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparator1 - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH3::CalculateMiddleClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparator1 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, std::round(getWidth() * m_fSeparator2 - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH3::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparator2 - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), getHeight() };
			result.validate();
			return result;
