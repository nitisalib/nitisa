...
namespace nitisa
{
	namespace standard
	{
		CMonthCalendarEventList::CMonthCalendarEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}IMonthCalendar *sender", L"sender"))
				->AddForwardDeclaration(L"class IMonthCalendar;", L"Standard/Controls/IMonthCalendar.h", L"standard");
		}
	}
}