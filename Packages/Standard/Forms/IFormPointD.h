...
namespace nitisa
{
	namespace standard
	{
		...
		protected:
			IFormPointD() = default;
			~IFormPointD() = default;
			IFormPointD(const IFormPointD &other) = delete;
			IFormPointD(IFormPointD &&other) = delete;
			IFormPointD &operator=(const IFormPointD &other) = delete;
			IFormPointD &operator=(IFormPointD &&other) = delete;
		public:
