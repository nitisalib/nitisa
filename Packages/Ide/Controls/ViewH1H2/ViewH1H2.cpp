...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewH1H2::CViewH1H2() :
			CControl(L"ViewH1H2", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
		...
		{
			setService(new CViewH1H2Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewH1H2::CViewH1H2(IForm *parent) :
			CViewH1H2()
		{
			setForm(parent);
		}

		CViewH1H2::CViewH1H2(IControl *parent) :
			CViewH1H2()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewH1H2::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewH1H2::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewH1H2 getters
		bool CViewH1H2::isResizable()
		{
			return m_bResizable;
		}

		float CViewH1H2::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewH1H2::getSeparatorV()
		{
			return m_fSeparatorV;
		}
	#pragma endregion

	#pragma region IViewH1H2 setters
		bool CViewH1H2::setResizable(const bool value)
		{
		...
		bool CViewH1H2::setSeparatorH(const float value)
		{
		...
		bool CViewH1H2::setSeparatorV(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 1) };
	...
	#pragma region Getters
		CViewH1H2::View CViewH1H2::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewH1H2::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewH1H2::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewH1H2::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewH1H2::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewH1H2::setActiveView(const View value)
		{
		...
		bool CViewH1H2::setBorderWidth(const float value)
		{
		...
		bool CViewH1H2::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewH1H2::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewH1H2::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewH1H2::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewH1H2::CalculateSeparatorHRect()
		{
		...
		RectF CViewH1H2::CalculateSeparatorVRect()
		{
		...
		RectF CViewH1H2::CalculateLeftViewRect()
		{
		...
		RectF CViewH1H2::CalculateRightViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H2::CalculateTopViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewH1H2::CalculateLeftClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H2::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, getWidth(), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewH1H2::CalculateTopClientRect()
		{
			RectF result{ 0, 0, getWidth(), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
