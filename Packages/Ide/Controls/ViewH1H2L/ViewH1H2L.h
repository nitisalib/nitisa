...
namespace nitisa
{
	...
	namespace ide
	{
		class CViewH1H2L :public virtual IViewH1H2L, public CControl
		{
			friend class CViewH1H2LService;
		public:
			enum class State
			{
				Normal,
		...
		public:
			...
			CViewH1H2L();
			CViewH1H2L(IForm *parent);
			CViewH1H2L(IControl *parent);
