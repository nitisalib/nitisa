...
namespace nitisa
{
	namespace standard
	{
		...
		class CCheckBoxService :public virtual ICheckBoxService, public CControlService
		{
		private:
		...
		public:
			CCheckBoxService(CCheckBox *checkbox);

			bool setChecked(const ICheckBox::CheckedState value) override;
