...
namespace nitisa
{
	namespace standard
	{
		CTrackRangeEventList::CTrackRangeEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnChange", L"{namespace}ITrackRange *sender", L"sender"))
				->AddForwardDeclaration(L"class ITrackRange;", L"Standard/Controls/ITrackRange.h", L"standard");
		}
	}
}