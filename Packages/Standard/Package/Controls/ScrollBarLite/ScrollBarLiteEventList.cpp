...
namespace nitisa
{
	namespace standard
	{
		CScrollBarLiteEventList::CScrollBarLiteEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnScroll", L"IControl *sender", L"sender"))
