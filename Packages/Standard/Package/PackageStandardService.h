...
namespace nitisa
{
	...
	namespace standard
	{
		class CPackageStandard;

		class CPackageStandardService :public virtual IPackageService
		{
		private:
			CPackageStandard *m_pPackage;
		public:
			...
			CPackageStandardService(CPackageStandard *package);
			virtual ~CPackageStandardService() = default;
		};
	}
}