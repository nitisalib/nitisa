...
namespace nitisa
{
	namespace charts
	{
		CForexChartEventList::CForexChartEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnHoverPoint", L"{namespace}IForexChart *sender, const int index", L"sender, index"))
				->AddForwardDeclaration(L"class IForexChart;", L"Charts/Controls/IForexChart.h", L"charts");
			Add(new CEvent(this, control, L"OnLeavePoint", L"{namespace}IForexChart *sender", L"sender"))
				->AddForwardDeclaration(L"class IForexChart;", L"Charts/Controls/IForexChart.h", L"charts");
		}
	}
}