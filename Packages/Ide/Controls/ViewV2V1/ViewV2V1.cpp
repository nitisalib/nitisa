...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CViewV2V1::CViewV2V1() :
			CControl(L"ViewV2V1", true, true, true, false, false, false),
			m_bResizable{ true },
			m_fSeparatorH{ 0.5f },
			m_fSeparatorV{ 0.5f },
		...
		{
			setService(new CViewV2V1Service(this), true);
			setSize(PointF{ 640, 480 });
		}

		CViewV2V1::CViewV2V1(IForm *parent) :
			CViewV2V1()
		{
			setForm(parent);
		}

		CViewV2V1::CViewV2V1(IControl *parent) :
			CViewV2V1()
		{
			setParent(parent);
		}
	...
	#pragma region IControl getters
		CursorType CViewV2V1::getCursor()
		{
	...
	#pragma region IViewControl methods
		bool CViewV2V1::ActivateView(const int index)
		{
			if (index < 0)
	...
	#pragma region IViewV2V1 getters
		bool CViewV2V1::isResizable()
		{
			return m_bResizable;
		}

		float CViewV2V1::getSeparatorH()
		{
			return m_fSeparatorH;
		}

		float CViewV2V1::getSeparatorV()
		{
			return m_fSeparatorV;
		}
	#pragma endregion

	#pragma region IViewV2V1 setters
		bool CViewV2V1::setResizable(const bool value)
		{
		...
		bool CViewV2V1::setSeparatorH(const float value)
		{
		...
		bool CViewV2V1::setSeparatorV(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 1) };
	...
	#pragma region Getters
		CViewV2V1::View CViewV2V1::getActiveView()
		{
			return m_eActiveView;
		}

		float CViewV2V1::getBorderWidth()
		{
			return m_fBorderWidth;
		}

		float CViewV2V1::getSeparatorWidth()
		{
			return m_fSeparatorWidth;
		}

		Color CViewV2V1::getBorderColor(const State state)
		{
			return m_aBorderColor[(int)state];
		}

		Color CViewV2V1::getSeparatorColor(const State state)
		{
	...
	#pragma region Setters
		bool CViewV2V1::setActiveView(const View value)
		{
		...
		bool CViewV2V1::setBorderWidth(const float value)
		{
		...
		bool CViewV2V1::setSeparatorWidth(const float value)
		{
			float v{ ntl::Clamp<float>(value, 0, 16) };
		...
		bool CViewV2V1::setBorderColor(const State state, const Color &value)
		{
		...
		bool CViewV2V1::setSeparatorColor(const State state, const Color &value)
		{
	...
	#pragma region Helpers
		void CViewV2V1::UpdateFromStyle(IStyle *style)
		{
		...
		RectF CViewV2V1::CalculateSeparatorHRect()
		{
		...
		RectF CViewV2V1::CalculateSeparatorVRect()
		{
		...
		RectF CViewV2V1::CalculateTopViewRect()
		{
		...
		RectF CViewV2V1::CalculateBottomViewRect()
		{
			if (ntl::IsZero<float>(m_fBorderWidth) || ntl::IsZero<float>(getWidth()) || ntl::IsZero<float>(getHeight()))
				return RectF{ 0, 0, 0, 0 };
		...
		RectF CViewV2V1::CalculateRightViewRect()
		{
		...
		RectF CViewV2V1::CalculateTopClientRect()
		{
			RectF result{ 0, 0, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) };
			result.validate();
			return result;
		...
		RectF CViewV2V1::CalculateBottomClientRect()
		{
			RectF result{ 0, std::round(getHeight() * m_fSeparatorV - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f), getHeight() };
			result.validate();
			return result;
		...
		RectF CViewV2V1::CalculateRightClientRect()
		{
			RectF result{ std::round(getWidth() * m_fSeparatorH - m_fSeparatorWidth * 0.5f) + m_fSeparatorWidth, 0, getWidth(), getHeight() };
			result.validate();
			return result;
