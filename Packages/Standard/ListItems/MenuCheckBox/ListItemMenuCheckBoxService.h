...
namespace nitisa
{
	...
	namespace standard
	{
		class CListItemMenuCheckBox;

		class CListItemMenuCheckBoxService :public CListItemMenuService
		{
		private:
			CListItemMenuCheckBox *m_pItem;
			bool m_bMouseDown;
		public:
			CListItemMenuCheckBoxService(CListItemMenuCheckBox *item);
