	...
	namespace platform
	{
		namespace windows
		{
			...
			private:
				...
				String ExtractPrintDeviceName(void *mode);
				bool ExtractPrintLandscape(void *mode);
				PrintPaperSize ExtractPrintPaperSize(void *mode);
				float ExtractPrintPaperLength(void *mode);
				float ExtractPrintPaperWidth(void *mode);
				float ExtractPrintScale(void *mode);
				int ExtractPrintCopies(void *mode);
				PrintPaperSource ExtractPrintPaperSource(void *mode);
				PrintQuality ExtractPrintQuality(void *mode);
				bool ExtractPrintMonochrome(void *mode);
				PrintDuplex ExtractPrintDuplex(void *mode);
				PrintTTOption ExtractPrintTTOption(void *mode);
				bool ExtractPrintCollate(void *mode);
				PrintMediaType ExtractPrintMediaType(void *mode);
				PrintDitherType ExtractPrintDitherType(void *mode);
			public:
				// Messages
