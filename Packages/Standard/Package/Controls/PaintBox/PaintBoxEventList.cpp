...
namespace nitisa
{
	namespace standard
	{
		CPaintBoxEventList::CPaintBoxEventList(IPackage *package, IControl *control, IPackageEntity *entity) :CControlEventList(package, control, entity)
		{
			// Other input events
			Delete(L"OnHotkey");
			...
			Add(new CEvent(this, control, L"OnDraw", L"{namespace}IPaintBox *sender", L"sender"))
				->AddForwardDeclaration(L"class IPaintBox;", L"Standard/Controls/IPaintBox.h", L"standard");
		}
	}
}