...
namespace nitisa
{
	...
	#pragma region Constructor & destructor
		CBlinnPhongMaterial::CBlinnPhongMaterial() :
			CControl(L"BlinnPhongMaterial", false, true, false, false, false, false),
			m_pTexture{ nullptr },
		...
		{
			setService(new CBlinnPhongMaterialService(this), true);
		}

		CBlinnPhongMaterial::CBlinnPhongMaterial(IControl *parent) :CBlinnPhongMaterial()
		{
			setParent(parent);
		}
	#pragma endregion
	...
	#pragma region IControl getters
		bool CBlinnPhongMaterial::isAcceptControl()
		{
			return CControl::isAcceptControl();
		}

		bool CBlinnPhongMaterial::isAcceptControl(IControl *control)
		{
	...
	#pragma region IMaterialControl methods
		bool CBlinnPhongMaterial::Activate(COpenGL *graphics, IModel *model, ICamera *camera)
		{
			IRenderer *renderer{ getForm()->getRenderer() };
			if (!m_pProgram)
			{
				if (!(m_pProgram = renderer->CreateProgram(shaders::blinn_phong::Vertex, shaders::blinn_phong::Fragment)))
					return false;
	...
	#pragma region IBlinnPhongMaterial getters
		ITexture *CBlinnPhongMaterial::getTexture()
		{
			return m_pTexture;
		}

		Color CBlinnPhongMaterial::getAmbientColor()
		{
			return m_sAmbientColor;
		}

		Color CBlinnPhongMaterial::getDiffuseColor()
		{
			return m_sDiffuseColor;
		}

		Color CBlinnPhongMaterial::getSpecularColor()
		{
			return m_sSpecularColor;
		}

		Color CBlinnPhongMaterial::getLightDiffuseColor()
		{
			return m_sLightDiffuseColor;
		}

		Color CBlinnPhongMaterial::getLightSpecularColor()
		{
			return m_sLightSpecularColor;
		}

		Vec3f CBlinnPhongMaterial::getLightPosition()
		{
			return m_sLightPosition;
		}

		float CBlinnPhongMaterial::getLightX()
		{
			return m_sLightPosition.X;
		}

		float CBlinnPhongMaterial::getLightY()
		{
			return m_sLightPosition.Y;
		}

		float CBlinnPhongMaterial::getLightZ()
		{
			return m_sLightPosition.Z;
		}

		float CBlinnPhongMaterial::getShininess()
		{
			return m_fShininess;
		}
	#pragma endregion

	#pragma region IBlinnPhongMaterial setters
		bool CBlinnPhongMaterial::setTexture(ITexture *value)
		{
			m_pTexture = value;
		...
		bool CBlinnPhongMaterial::setAmbientColor(const Color &value)
		{
		...
		bool CBlinnPhongMaterial::setDiffuseColor(const Color &value)
		{
		...
		bool CBlinnPhongMaterial::setSpecularColor(const Color &value)
		{
		...
		bool CBlinnPhongMaterial::setLightDiffuseColor(const Color &value)
		{
		...
		bool CBlinnPhongMaterial::setLightSpecularColor(const Color &value)
		{
		...
		bool CBlinnPhongMaterial::setLightPosition(const Vec3f &value)
		{
		...
		bool CBlinnPhongMaterial::setLightX(const float value)
		{
		...
		bool CBlinnPhongMaterial::setLightY(const float value)
		{
		...
		bool CBlinnPhongMaterial::setLightZ(const float value)
		{
		...
		bool CBlinnPhongMaterial::setShininess(const float value)
		{
