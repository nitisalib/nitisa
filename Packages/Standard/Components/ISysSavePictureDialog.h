...
namespace nitisa
{
	namespace standard
	{
		class ISysSavePictureDialog :public virtual IComponent
		{
		protected:
			ISysSavePictureDialog() = default;
			~ISysSavePictureDialog() = default;
			ISysSavePictureDialog(const ISysSavePictureDialog &other) = delete;
			ISysSavePictureDialog(ISysSavePictureDialog &&other) = delete;
			ISysSavePictureDialog &operator=(const ISysSavePictureDialog &other) = delete;
			ISysSavePictureDialog &operator=(ISysSavePictureDialog &&other) = delete;
		public:
