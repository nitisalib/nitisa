...
// For example:
//     FormIntegerArrayProto.h:
//         #include "IFormIntegerArrayProto.h" // Include this file
//
//         namespace nitisa
//         {
//             class IControl;
...
//             namespace standard
//             {
//                 class CFormIntegerArrayProto : public IFormIntegerArrayProto // Derive your form from class from this file
//                 {
...
//                 public:
//                     CFormIntegerArrayProto(); // Declare constructor
//                 };
//             }
//         }
//
//     FormIntegerArrayProto.cpp:
...
//         #include "FormIntegerArrayProto.h" // Include header class of your form
//
//         namespace nitisa
//         {
//             namespace standard
//             {
//                 CFormIntegerArrayProto::CFormIntegerArrayProto(): // Implement constructor of your form
//                     IFormIntegerArrayProto(new standard::windows::CWindow(), new standard::windows::opengl::CRenderer(false, 0))
//                 {
//                     // Insert your code here
//                 }
//
//                 void CFormIntegerArrayProto::ButtonAdd_OnClick(IControl *sender) // Implement event processing methods
//                 {
//                     // Insert your code here
//                 }
//             }
...
namespace nitisa
{
	...
	namespace standard
	{
		class IFormIntegerArrayProto : public CForm
		{
		protected:
			// Controls
		...
		protected:
			...
			virtual void FormIntegerArrayProto_OnKeyUp(IForm *sender, const MessageKey &m) = 0;
		...
		private:
			void Initialize()
			{
				...
				m_pListBoxArray->OnSelect = [](IControl *sender, IListItem *item)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ListBoxArray_OnSelect(sender, item); };

				m_pButtonAdd->setName(L"ButtonAdd");
				m_pButtonAdd->getTransform()->Translate(192.0f, 32.0f, 0.0f);
				m_pButtonAdd->setTabOrder(4);
				m_pButtonAdd->setCaption(UTF8ToString("Add"));
				m_pButtonAdd->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonAdd_OnClick(sender); };
				...
				m_pButtonUpdate->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonUpdate_OnClick(sender); };
				...
				m_pButtonDelete->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonDelete_OnClick(sender); };
				...
				m_pButtonClear->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonClear_OnClick(sender); };
				...
				m_pButtonOk->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonOk_OnClick(sender); };
				...
				m_pButtonCancel->OnClick = [](IControl *sender)->void { cast<IFormIntegerArrayProto*>(sender->getForm())->ButtonCancel_OnClick(sender); };
		...
		public:
			IFormIntegerArrayProto(IWindow *window, IRenderer *renderer, const String &class_name = L"FormIntegerArrayProto", const CreateParams *params = nullptr) :
				...
				m_pLabelMaxValue{ nullptr }
			{
				if (window)
				{
					...
					setName(L"FormIntegerArrayProto");
					...
					OnKeyUp = [](IForm *sender, const MessageKey &m)->void { cast<IFormIntegerArrayProto*>(sender)->FormIntegerArrayProto_OnKeyUp(sender, m); };
				}
			}
		};
	}
