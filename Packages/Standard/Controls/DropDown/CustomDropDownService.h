...
namespace nitisa
{
	...
	namespace standard
	{
		class CCustomDropDown;

		class CCustomDropDownService :public virtual IComponentItemListService, public CControlService
		{
		private:
			CCustomDropDown *m_pDropDown;
		public:
			CCustomDropDownService(CCustomDropDown *dropdown);
